        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-base md:text-lg text-slate-600 dark:text-slate-400 leading-relaxed max-w-2xl">
              <p>
                A final year undergraduate at <span className="font-semibold text-slate-900 dark:text-white border-b-2 border-brand-blue/30">BITS Pilani</span> with a strong interest in <span className="text-brand-purple font-semibold">product</span>, <span className="text-brand-purple font-semibold">strategy</span> and <span className="text-brand-purple font-semibold">problem solving</span> at scale.
              </p>
              <p>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <a 
              href="https://drive.google.com/drive/folders/19JKeVKS61LHXPESM3bTSDeftl56TwgZd?usp=sharing"
              target="_blank"
